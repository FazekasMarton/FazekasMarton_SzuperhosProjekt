...
public abstract class Bosszuallo implements Szuperhos {
    ...
    public boolean legyoziE(Szuperhos szuperhos) {
        if (szuperhos instanceof Bosszuallo) {
            ...
            return bosszuallo.vanEGyengesege && this.szuperero > bosszuallo.mekkoraAzEreje();
    ...
    public String toString() {
        return MessageFormat.format("Szupererő: {0}; {1}", szuperero, (vanEGyengesege ? "van gyengesége" : "nincs gyengesége"));
    }
}
